...
public class Quantity implements Comparable<Quantity> {
    ...
    public static final String MESSAGE_CONSTRAINTS =
            "Quantity should only contain numbers, and it should be between 1-7 digits long, \n"
    ...
    public static final String MESSAGE_CONSTRAINTS_MAX_QUANTITY =
            "Max Quantity should only contain numbers, it should be between 1-7 digits long, \n"
